...
export class Box {
  ...
  fill?: p5.Color
  constructor (
    {x,y,w,r,h, bodyBuffer=1.25, anglePattern=0, type, stroke,fill, isStatic}: {
      isStatic?:boolean,
      stroke: p5.Color,fill?: p5.Color,x:number, y:number, w?:number, h?:number,r?:number, bodyBuffer?:number,anglePattern?:number, type: BoxType},
    ...
    if (type == BoxType.rect){
      ...
      this.body = Matter.Bodies.circle(x, y, r!*bodyBuffer, options);
    }
    this.w = w;
    this.h = h;
    this.x = x
